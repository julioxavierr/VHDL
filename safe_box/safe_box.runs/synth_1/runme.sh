...
HD_PWD='C:/Mac/Home/Desktop/SD1/VHDL/safe_box/safe_box.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register.vds -m64 -mode batch -messageDb vivado.pb -notrace -source shift_register.tcl
