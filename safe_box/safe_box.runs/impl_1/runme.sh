...
HD_PWD='C:/Mac/Home/Desktop/SD1/VHDL/safe_box/safe_box.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log shift_register.vdi -applog -m64 -messageDb vivado.pb -mode batch -source shift_register.tcl -notrace
